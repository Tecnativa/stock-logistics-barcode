        ...
        start: function() {
            if (this.modelName.includes("wiz.stock.barcodes.read")) {
                if (this.call("bus_service", "isMasterTab")) {
                    ...
                    this.call("bus_service", "addChannel", "stock_barcodes_read-" + this.initialState.data.id);
                    this.call("bus_service", "addChannel", "stock_barcodes_sound-" + this.initialState.data.id);
                }
                this.call("bus_service", "on", "notification", this, this.bus_notification);
                this.$sound_ok = $('<audio src="/stock_barcodes/static/src/sounds/bell.wav" preload="auto"></audio>');
                this.$sound_ko = $('<audio src="/stock_barcodes/static/src/sounds/error.wav" preload="auto"/>');
    ...
    //            this.$sound_ok = $('<audio controls="controls" autobuffer="autobuffer" autoplay="autoplay"> <source src="data:audio/wav;base64," /> </audio>');
        ...
        bus_notification: function(notifications) {
            ...
            _.each(notifications, function(notification) {
                ...
                } else if (channel === "stock_barcodes_sound-" + self.initialState.data.id) {
                    if (message.sound === "ok") {
...
//                alert(ev.keyCode);
                ...
                if (ev.keyCode === 49){
                    debugger;
                    console.log(this.initialState.context.display_menu);
                    if (this.initialState.context.display_menu === true){
                        ...
                        this.do_action({
                            ...
                            name: 'Test',
                            target: 'current',
                            res_id: wizard.data.action_ids.data[0].data.action_window_id.data.id,
