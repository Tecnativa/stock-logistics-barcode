    ...
    FormController.include({
        ...
        start: function() {
            if (this.call("bus_service", "isMasterTab")) {
                ...
                this.call("bus_service", "addChannel", "stock_barcodes_sound");
            }
            this.call("bus_service", "on", "notification", this, this.bus_notification);
//            this.$sound_ok = $('<audio src="/stock_barcodes/static/src/sounds/bell.wav" autoplay="false"></audio>');
...
//                self.$sound_ko.play();
                ...
                } else if (channel === "stock_barcodes_sound") {
                    // TODO: Remove
